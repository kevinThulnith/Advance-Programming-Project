        ...
        <div className="max-w-7xl mx-auto glass-panel-light p-4 md:p-6 shadow-xl flex flex-col lg:flex-row gap-6 items-center lg:items-end rounded-2xl">
          ...
          <div className="w-full lg:flex-1 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col">
              <label className="text-xs text-gray-500 font-['Montserrat'] uppercase tracking-wider mb-1.5 ml-1">Dates</label>
            ...
            {/* Occupancy */}
            <div className="flex flex-col">
              <label className="text-xs text-gray-500 font-['Montserrat'] uppercase tracking-wider mb-1.5 ml-1">Guests</label>
              <select 
            ...
            <div className="flex flex-col">
              <div className="flex justify-between items-center mb-1.5 px-1">
                <label className="text-xs text-gray-500 font-['Montserrat'] uppercase tracking-wider">Max Price</label>
                <span className="text-xs font-bold text-[var(--color-primary-deep)]">${priceMax}</span>
              </div>
              <input 
                type="range" 
        ...
        {filteredRooms.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 animate-fade-in">
             <div className="w-24 h-24 mb-6 text-gray-300">
               <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
             </div>
             <h3 className="text-2xl font-['Playfair_Display'] text-[var(--color-primary-deep)] mb-2">No rooms found</h3>
             <p className="text-gray-500 mb-6">We couldn't find any rooms matching your current filters.</p>
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-1">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      <span className="text-xs text-gray-400 font-['Montserrat']">ROOM 10{room.id}</span>
                      <h3 className="text-xl font-['Playfair_Display'] text-[var(--color-primary-deep)] font-bold mt-1">{room.name}</h3>
                    </div>
                  </div>
                  
                  <div className="flex items-center space-x-4 mb-4 text-xs text-gray-500">
                    <span className="flex items-center"><svg className="w-4 h-4 mr-1 text-[var(--color-accent-gold)]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg> Floor {room.floor}</span>
                    <span className="flex items-center"><svg className="w-4 h-4 mr-1 text-[var(--color-accent-gold)]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg> Max {room.maxOccupancy}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                    <div className="flex flex-col">
                      <span className="text-[var(--color-accent-gold)] text-2xl font-bold font-['Playfair_Display']">${room.price}</span>
